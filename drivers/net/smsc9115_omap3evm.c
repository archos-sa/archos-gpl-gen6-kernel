 ...
 *
 *   25/01/2008 ssrinivasrao@mistralsolutions.com
 *     - added support for OMAP3EVM board
 */
...
static int smsc911x_drv_probe(struct platform_device *pdev)
{
	...
	smsc911x_reg_write(intcfg, pdata, INT_CFG);
	retval = request_irq(dev->irq, smsc911x_irqhandler, IRQF_SHARED | IRQF_TRIGGER_FALLING,
			     SMSC_CHIPNAME, dev);
	if (retval) {
