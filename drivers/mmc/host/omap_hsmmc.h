...
#define OMAP_HSMMC_DATA_ENDBITERR     	(1 << 22)   /* Data end bit error */
#define OMAP_HSMMC_STAT_CLEAR	0xFFFFFFFF
#define OMAP_HSMMC_ERR_MASK	(OMAP_HSMMC_ERR | OMAP_HSMMC_CMD_TIMEOUT | OMAP_HSMMC_DATA_TIMEOUT | OMAP_HSMMC_CMD_CRC | OMAP_HSMMC_DATA_CRC | OMAP_HSMMC_CARD_ERR) 
...
#define MMC_TIMEOUT_MS	500
#define NO_OF_MMC_HOSTS 3
