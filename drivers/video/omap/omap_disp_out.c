...
#if defined(CONFIG_FB_OMAP_LCD_VGA) || defined(CONFIG_OMAP3_EVM_LCD_VGA)
...
bypass_gpio:
...
#ifdef CONFIG_OMAP3_EVM_LCD_VGA
	...
	clkdiv = pixclock / (1000000000UL/omap2_disp_get_dssfclk());
...
h4_i2c_tvout_off(struct work_struct *work)
{
	...
	omap2_disp_set_tvref(TVREF_OFF);
	omap2_disp_put_all_clks();
	twl4030_i2c_write_u8(TWL4030_MODULE_PM_RECIEVER,0x00,TWL4030_VDAC_DEDICATED);
	twl4030_i2c_write_u8(TWL4030_MODULE_PM_RECIEVER,0x00,TWL4030_VDAC_DEV_GRP);
#endif
}
