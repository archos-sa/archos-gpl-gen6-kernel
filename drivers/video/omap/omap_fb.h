...
/* SL : define the custom FBIO_SET_PANEL_OUTPUT ioctl */
#define FBIO_SET_PANEL_OUTPUT	_IOW('F', 0x23, struct omap_fb_panel_select)

/* SL : define the custom FBIO_GFX_LAYER_ENABLE ioctl */
#define FBIO_GFX_LAYER_ENABLE	_IOW('F', 0x24, u_int32_t)
