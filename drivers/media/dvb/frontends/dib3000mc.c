				...
				struct dvb_frontend_parameters *fep)
{
	...
	switch( state->current_bandwidth ) {
		case 7000: fep->u.ofdm.bandwidth = BANDWIDTH_7_MHZ; break;
		case 6000: fep->u.ofdm.bandwidth = BANDWIDTH_6_MHZ; break;
		case 8000:
		default: fep->u.ofdm.bandwidth = BANDWIDTH_8_MHZ; break;	
	}
