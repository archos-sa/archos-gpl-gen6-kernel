		      ...
		      const struct v4l2_rect *new_crop)
{
...
#if 0
	printk("omap24xxvout_new_crop:\n");
	printk("win  WxH %4d x %4d  ofs %4d x %4d\n", win->w.width, win->w.height, win->w.left, win->w.top);
	printk("pix  WxH %4d x %4d\n", pix->width,   pix->height);
	printk("crop WxH %4d x %4d  ofs %4d x %4d\n", crop->width, crop->height, crop->left, crop->top );
	printk("new  WxH %4d x %4d  ofs %4d x %4d\n", new_crop->width, new_crop->height, new_crop->left, new_crop->top );
	printk("*************************************\n");
#endif
	...
	*crop = try_crop;
#if 0
	printk("omap24xxvout_new_crop end:\n");
	printk("win  WxH %4d x %4d  ofs %4d x %4d\n", win->w.width, win->w.height, win->w.left, win->w.top);
	printk("pix  WxH %4d x %4d\n", pix->width,   pix->height);
	printk("crop WxH %4d x %4d  ofs %4d x %4d\n", crop->width, crop->height, crop->left, crop->top );
	printk("*************************************\n");
