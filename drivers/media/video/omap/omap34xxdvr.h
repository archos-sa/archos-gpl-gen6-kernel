/*
 * drivers/media/video/omap/omap34xxdvr.h
 *
...
#ifndef OMAP34XXDVR_H
#define OMAP34XXDVR_H
...
struct omap34xxdvr_device {
	...
	spinlock_t img_lock;
 	 ...
 	 */
	struct omap34xxdvr_fh *streaming;
	/* We allow previewing from at most one filehandle at a time.  
	 * non-NULL means previewing is in progress.
	 */
	struct omap34xxdvr_fh *previewing;
	
	int still_capture;  /* currently doing a still */
	...
	struct video_decoder *dvr_decoder;
...
struct omap34xxdvr_fh {
	struct omap34xxdvr_device *dvr;
	enum v4l2_buf_type type;
	struct videobuf_queue vbq;
};
#endif	/* ifndef OMAP34XXDVR_H */
