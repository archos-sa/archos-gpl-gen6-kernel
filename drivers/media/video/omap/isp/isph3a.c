...
isph3a_aewb_mmap_buffers(struct isph3a_aewb_buffer *buffer)
{
	...
	vma.vm_pgoff = pgoff;
	vma.vm_file = NULL;
#warning "protection_map does not exist!!!"
...
#ifdef CONFIG_VIDEO_OMAP34XX_CAMERA
...
EXPORT_SYMBOL(isph3a_aewb_init);
EXPORT_SYMBOL(isph3a_aewb_cleanup);
