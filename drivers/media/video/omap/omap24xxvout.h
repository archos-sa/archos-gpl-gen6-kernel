...
#define VIDIOC_OMAP2_VID1_LAYER_ENABLE		_IO ('V', 100)
#define VIDIOC_OMAP2_VID1_LAYER_DISABLE		_IO ('V', 101)
#define VIDIOC_OMAP2_VID2_LAYER_ENABLE		_IO ('V', 102)
#define VIDIOC_OMAP2_VID2_LAYER_DISABLE		_IO ('V', 103)
