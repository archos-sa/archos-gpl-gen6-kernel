...
#define CONFIG_I2C_TWL4030_ID	1   /* on I2C1 for 3430SDP */
#elif defined(CONFIG_MACH_OMAP3_EVM)
#define CONFIG_I2C_TWL4030_ID   1   /* on I2C1 for OMAP3EVM */
#else
...
MAK_MOD(4, pih)
MAK_MOD(5, test)
MAK_MOD(6, interrupts)
MAK_MOD(7, led)
MAK_MOD(8, madc)
MAK_MOD(9, main_charge)
MAK_MOD(10, precharge)
MAK_MOD(11, pwm0)
MAK_MOD(12, pwm1)
MAK_MOD(13, pwma)
MAK_MOD(14, pwmb)
