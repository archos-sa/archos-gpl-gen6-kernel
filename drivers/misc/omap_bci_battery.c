 ...
 * helper function
 */
static inline int twl4030bci_status_evt(void)
{	
	int std;
...
{	
	...
	ret = clear_n_set(TWL4030_MODULE_PM_RECIEVER, 0, BBCHEN,
		REG_BB_CFG);
	if (ret)
		return ret;
...
static void twl4030_bat_event_handler(struct work_struct *work)
{
	...
	/* struct timer_list *ptr_tmr_bci_std = (struct timer_list *) data; */
