...
#else
#define OMAP2_MCBSP1_BASE_PHY		(L4_BASE + 0x74000)
#define OMAP2_MCBSP2_BASE_PHY		(L4_PER_BASE + 0x22000)
#define OMAP2_MCBSP3_BASE_PHY		(L4_PER_BASE + 0x24000)
#define OMAP2_MCBSP4_BASE_PHY		(L4_PER_BASE + 0x26000)
#define OMAP2_MCBSP5_BASE_PHY		(L4_BASE + 0x96000)
