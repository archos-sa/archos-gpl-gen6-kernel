...
#define OMAP_DMA4_BASE			(L4_BASE + 0x56000)
...
struct omap_dma_channel_params {
	...
	int frame_count;	/* number of frames in a block */

        //elements = pixel, frame = line, block = image
...
#ifndef CONFIG_ARCH_OMAP1
	enum omap_dma_burst_mode src_burst_mode; /* Burst mode 4/8/16 words */
	enum omap_dma_burst_mode dst_burst_mode;
#endif
};
...
extern int omap_dma_ch_running(int lch);
...
extern void omap_dma_set_interrupt_ch(int chain_id, u16 irq, u16 last_irq);
extern int omap_dma_set_src_burst_mode_ch(int chain_id, enum omap_dma_burst_mode burst_mode);
extern int omap_dma_set_dest_burst_mode_ch(int chain_id, enum omap_dma_burst_mode burst_mode);
