...
/* resource - vaux4 */
#define ENABLE_VAUX4_DEDICATED  0x05
#define ENABLE_VAUX4_DEV_GRP    0x20
...
/* boot config */
#define R_CFGBOOT		PHY_TO_OFF_PM_MASTER(0x3b)
...
/* access control */
#define R_PROTECTKEY		PHY_TO_OFF_PM_MASTER(0x44)
