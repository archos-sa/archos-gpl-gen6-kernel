...
/* All channels are enabled without masking*/
#define OMAP2_MCBSP_TXMUTICH_ENABLE_NOMASK	0 
/*All channels are disabled, and therefore masked by default*/
#define OMAP2_MCBSP_TXMUTICH_DISABLE_MASK	1 
/*All channels are enabled, but masked */
#define OMAP2_MCBSP_TXMUTICH_ENABLE_MASK	2
/*All channels are disabled, and used for symmetric tx/rx*/
#define OMAP2_MCBSP_TXMUTICH_DISABLE_SYMETRIC	3
...
/* Interrupt Handling */
typedef void (*omap2_mcbsp_isr_t) (void *arg, u32 irq_status, struct pt_regs * regs);
 ...
 */
int omap2_mcbsp_txmultich_cfg(u32 mcbsp_id, u8 part_mode,u8 part_ablk,u8 part_bblk,
						u8 parta_enable, u8 partb_enable);
/*
 * Receive multichannel configuration
 */						
int omap2_mcbsp_rxmultich_cfg(u32 mcbsp_id,u8 part_mode,u8 part_ablk,u8 part_bblk,
						u8 parta_enable, u8 partb_enable);
