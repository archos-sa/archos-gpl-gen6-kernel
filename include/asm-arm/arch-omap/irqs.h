...
#define INT_34XX_SR1_IRQ        18 
#define INT_34XX_SR2_IRQ        19 
...
#if defined (CONFIG_FIQ) && !defined __ASSEMBLY__
extern void move_irq_to_fiq(int controller_no, int irq_no);
#endif
