...
#define VENC_GEN_CTRL_PAL_VAL			0x00FF0000
...
#define VENC_DAC_LUMA_ENABLE			(0x1<<0)
#define VENC_DAC_COMPOSITE_ENABLE		(0x1<<1)
#define VENC_DAC_CHROMA_ENABLE			(0x1<<2)
#define VENC_DAC_VIDEO_INVERT			(0x1<<3)
#define VENC_DAC_VIDEO_TEST_MODE		(0x1<<4)
...
#define VENC_GAIN_Y_NTSC_M			0x000001a0
#else
...
#ifdef CONFIG_MACH_ARCHOS_G6
#define VENC_BLACK_LEVEL_NTSC_M			0x00000070
#define VENC_BLANK_LEVEL_NTSC_M			0x00000060
#else
...
#define VENC_AVID_START_STOP_X_NTSC		0x03480078
#define VENC_AVID_START_STOP_X_NTSC_443		0x03480079

#define VENC_AVID_START_STOP_Y_NTSC		0x02060024
