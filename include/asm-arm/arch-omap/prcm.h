...
#define PRCM_FSHOST	(ID_OMAP(AT_3430) | ID_TYPE((ID_DEV | ID_CLK_DIV)) | ID_DEV_TYPE(INITIATOR) \
...
#define PRCM_SGX_ICLK	(ID_OMAP(AT_3430_ES2) | ID_TYPE(ID_DEV) | ID_DEV_TYPE(INITIATOR)\
						| ID_DOMAIN(DOM_SGX) | ID_DEV_BIT_POS(0x0))
#define PRCM_SGX_FCLK	(ID_OMAP(AT_3430_ES2) | ID_TYPE((ID_DEV | ID_CLK_DIV))\
			 | ID_DOMAIN(DOM_SGX) | ID_DEV_TYPE(TARGET) | ID_CLK_NO(0x6)\
			 | ID_DEV_BIT_POS(0x1))
#define PRCM_3D_CONSTRAINT	(ID_OMAP(AT_3430) | \
				 OTHER_ID_TYPE(ID_CONSTRAINT_CLK) | \
				 ID_DOMAIN(DOM_SGX))
#else
#define PRCM_GFX	(ID_OMAP(AT_3430) | ID_TYPE(ID_DEV) | ID_DEV_TYPE(INITIATOR)\
...
#define PRM_CLKSETUP_DURATION		0x0FF
#define PRM_VOLTSETUP_TIME2		0xFFF
#define PRM_VOLTSETUP_TIME1		0xFFF
#define PRM_VOLTOFFSET_DURATION		0x041
#define PRM_VOLTSETUP2_DURATION		0x041
