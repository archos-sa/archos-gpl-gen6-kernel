...
#define DISPC_GFX_ATTRIBUTES_GFXFORMAT_RGB24PACK	(9 <<  1)
#define DISPC_GFX_ATTRIBUTES_GFXFORMAT_ARGB32		(12 <<  1)
#define DISPC_GFX_ATTRIBUTES_GFXFORMAT_RGBA32		(13 <<  1)
#define DISPC_GFX_ATTRIBUTES_GFXFORMAT_RGBx32		(14 <<  1)
...
#define VENC_DAC_OUTPUT				0x00C4
#define VENC_DAC_TST				0x00C8
 ...
 * This function lony handle 25,2, 27 and 74.25 Mhz pixclock for now, if you want more, modify the function ! */
extern u32 omap2_disp_get_clkrate_g6_from_pixclock(u32 pixclock);
extern void omap2_disp_set_clkrate_g6(u32 clkrate);

/* used to retrieve the dss function clock, which
 * might be either dss1_alwon_fck or dsi1_pll_fclk */
extern u32 omap2_disp_get_dssfclk(void);
...
/* alpha blending */
extern int omap2_disp_get_alphablend(int output_dev);
extern void omap2_disp_set_alphablend(int output_dev,int value);
extern unsigned char omap2_disp_get_global_alphablend_value(int ltype);
extern void omap2_disp_set_global_alphablend_value(int ltype,int value);
...
/* interrupt handling */
typedef void (*omap2_disp_isr_t) (void *arg, struct pt_regs * regs, u32 irqstatus);
...
extern void omap2_disp_set_irq_on_linenumber(int val);
extern void omap2_disp_swap_dma_ba(int i, int time_base);

extern int omap2_disp_get_vrfb_offset(u32, u32, int);

extern void omap2_disp_start_video_layer(int);

extern void omap2_disp_set_addr(int ltype, u32 lcd_phys_addr, u32 tv_phys_addr_f0, u32 tv_phys_addr_f1);
