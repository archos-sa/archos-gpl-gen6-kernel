...
$(KERNEL): $(KERNEL_BUILD_DIR)/linux $(KERNEL_CONFIG)
	@(make -C $(KERNEL_SRC_DIR) O=$(KERNEL_BUILD_DIR)/linux ARCH=arm CROSS_COMPILE=arm-linux-)
...
.PHONY: kernel-clean kernel-cleaner $(KERNEL)
