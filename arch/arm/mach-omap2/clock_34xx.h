/*
 * linux/arch/arm/mach-omap3/clock.h
 *
 ...
 *
 * NOTE:
 *	In many cases here we are assigning a 'default' parent. In many
...
static struct vdd_prcm_config vdd1_rate_table[] = {
	{0, 0, 0},
	/*OPP1*/	{S125M, PRCM_VDD1_OPP1, RATE_IN_343X},
	/*OPP2*/	{S250M, PRCM_VDD1_OPP2, RATE_IN_343X},
	/*OPP3*/	{S500M, PRCM_VDD1_OPP3, RATE_IN_343X},
	/*OPP4*/	{S550M, PRCM_VDD1_OPP4, RATE_IN_343X},
	/*OPP5*/	{S600M, PRCM_VDD1_OPP5, RATE_IN_343X},
};

static struct vdd_prcm_config vdd2_rate_table[] = {
	{0, 0, 0},
	/*OPP1*/	{S19M, PRCM_VDD2_OPP1, RATE_IN_343X},
	/*OPP2*/	{S83M, PRCM_VDD2_OPP2, RATE_IN_343X},
	/*OPP3*/	{S166M, PRCM_VDD2_OPP3, RATE_IN_343X},
};
#define MAX_VDD1_OPP 5
#define MAX_VDD2_OPP 3
#else
static struct vdd_prcm_config vdd1_rate_table[] = {
	/*OPP1 */	{S477M, PRCM_VDD1_OPP1, RATE_IN_343X},
	/*OPP2 */	{S381M, PRCM_VDD1_OPP2, RATE_IN_343X},
	/*OPP3 */	{S191M, PRCM_VDD1_OPP3, RATE_IN_343X},
	/*OPP4 */	{S96M, PRCM_VDD1_OPP4, RATE_IN_343X},
	{0, 0, 0},
};

static struct vdd_prcm_config vdd2_rate_table[] = {
	/*OPP1 */	{S166M, PRCM_VDD2_OPP1, RATE_IN_343X},
	/*OPP2 */	{S83M, PRCM_VDD2_OPP2, RATE_IN_343X},
	{0, 0, 0},
};
#endif
...
#else
static struct clk func_96m_ck = {	/* same as DPLL4_M2X2_CLK */
	.name = "func_96m_ck",
	.parent = &sys_ck,
	.prcmid = PRCM_DPLL4_M2X2_CLK,
	.flags	= CLOCK_IN_OMAP343X |
...
static struct clk gfx_fck = {
	.name = "gfx_fck",
	.parent = &gfx_l3_ck,
	.flags = CLOCK_IN_OMAP343X | RATE_CKCTL | RATE_PROPAGATES,
	.prcmid = PRCM_GFX_L3_FCLK,
	.recalc = &omap3_clk_recalc,
};
...
static struct clk gfx_2d_fck = {
	.name = "gfx_2d_fck",
	.parent = &gfx_fck,	/* Need to confirm this */
	.prcmid = PRCM_2D,
	.flags = CLOCK_IN_OMAP343X | F_CLK,
	.recalc = &omap3_followparent_recalc,	/* Need to confirm this */
};
...
static struct clk d2d_ick = {
/* This node is used to represent sad2d_iclk and mdm_intc_clk
 *as there is a single control for both */
	.name = "d2d_ick",
	.prcmid = PRCM_D2D,
	.parent = &l3_ck,
	.flags = CLOCK_IN_OMAP343X | I_CLK,
...
static struct clk fsusb_ick = {
	.name = "fsusb_ick",
	.prcmid = PRCM_FSHOST,
	.parent = &l4_ck,
#ifdef CONFIG_OMAP_ZEBU
	.flags = CLOCK_IN_OMAP343X | I_CLK | VDD2_CONFIG_PARTICIPANT,
#else
	.flags = CLOCK_IN_OMAP343X | I_CLK | RATE_CKCTL |
		 VDD2_CONFIG_PARTICIPANT,
#endif
	.recalc = &omap3_clk_recalc,
};
...
static struct clk gpt9_fck = {
	.name = "gpt9_fck",
	.prcmid = PRCM_GPT9,
	.parent = &sys_32k_ck,	/* Can be sys_ck too */
	.rate = S_OSC,
	.flags = CLOCK_IN_OMAP343X | F_CLK | SRC_SEL | POWER_ON_REQUIRED,
	.recalc = &omap3_followparent_recalc,
};
