...
static struct spi_board_info g6l_spi_board_info[] = {
	[0] = { },
};
...
static struct archosg6_vbus_config vbus0_config __initdata = {
	.nrev = 4,
	.rev[0] = { .nb = 151, .mux_cfg = Y8_3430_GPIO151 },
	.rev[1] = { .nb = 151, .mux_cfg = Y8_3430_GPIO151 },
...
static struct archosg6_usb_config usb_config __initdata = {
	.nrev = 4, /* cover v0, v1 and v2 boards */
	.rev[0] = {
		.usb_id = { .nb = 102, .mux_cfg = R8_3430_GPIO56    },
...
static void __init _board_init(void)
{
	...
	/* ads before spi */
	ads7846_dev_init(&g6l_spi_board_info[0]);

	spi_register_board_info(g6l_spi_board_info,
				ARRAY_SIZE(g6l_spi_board_info));
...
MACHINE_START(ARCHOS_G6L, "ARCHOS G6L")
