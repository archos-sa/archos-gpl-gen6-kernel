 ...
 *  2007-04-16 Leonides Martinez - Additional controls info
 */
...
#if defined (CONFIG_MACH_OMAP_2430SDP) || defined (CONFIG_OMAP3430_ES2)
...
static void omap_twl4030_shutdown(void);
...
static struct mcbsp_config plat_mcbsp_config = {
	...
	.tx_params = {
			       ...
			       .word_length1 = OMAP2_MCBSP_WORDLEN_16,	/* RWDLEN1 */
			       .word_length2 = OMAP2_MCBSP_WORDLEN_16,	/* RWDLEN2 -dnt care*/
	...
	.rx_params = {
			       ...
			       .reverse_compand = OMAP2_MCBSP_MSBFIRST,	/* Set msb first */
			       .word_length1 = OMAP2_MCBSP_WORDLEN_16,	/* RWDLEN1 */
			       .word_length2 = OMAP2_MCBSP_WORDLEN_16,	/* RWDLEN2 -dntcare*/
			       .frame_length1 = OMAP2_MCBSP_FRAMELEN_1,	/* RFRLEN1 */
